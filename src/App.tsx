          ...
          <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">Content Automation</h1>
              </div>
            ...
            <Routes>
              ...
              <Route
                ...
                element={
                  <div className="p-8">
                    <div className="card">
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Content Management</h2>
                      <p className="text-gray-600 dark:text-gray-400">Content page coming soon...</p>
                    </div>
                  </div>
                }
              />
